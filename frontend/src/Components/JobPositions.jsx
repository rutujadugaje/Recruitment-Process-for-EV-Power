...
const JobPositions = () => {
  ...
  const allJobs = [
    ...
    },
    {
      ...
      location: "Chennai",
      description: "Responsible for assembling, testing, and maintaining battery systems.As a Battery Research Scientist, you will be responsible for conducting cutting-edge research in the field of advanced battery chemistries. Your primary goal will be to develop and optimize next-generation energy storage solutions, focusing on improving battery performance, energy density, safety, lifecycle, and cost-effectiveness. You will collaborate closely with cross-functional teams including material scientists, chemical engineers, and product development units.",
    },
    {
